...
import { ETCDDataProcessingOpts, GetAllResponse } from '../../core/replication/Etcd.js';
import { ValueSerializer } from '../../core/replication/EtcdModel.js';
import { ISODateString } from '../../core/types/ISODate.js';
import { InferType } from '../../core/types/Infer.js';
import { Action, AuditModel } from './models/Audit.js';
...
export class AuditProvider extends EventEmitter {
  ...
  constructor(private etcdProvider: ETCDProvider) { super(); }
